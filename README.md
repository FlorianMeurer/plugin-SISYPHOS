...
In order to run SISYPHOS in Olex2 you can copy this folder into the $OLEX2BASE\util\pyUtil\PluginLib\plugin-SISYPHOS (create the plugin-SISYPHOS folder there) and create a plugins.xld in the olex2 main folder which should have the following file content 
